...
@if(Session::has('message'))
    <div class=" flex-d alert alert-success alert-dismissible fade show" role="alert">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Form Elements">User Management</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{ route('admin.permissions.index') }}" class="menu-link">
                                <div data-i18n="Basic Inputs">permissions</div>
                            </a>
                        </li>
                        <li class="menu-item">
                        ...
                        <span class="d-flex align-items-center align-middle">
                          ...
                          <span class="flex-shrink-0 badge badge-center rounded-pill bg-danger w-px-20 h-px-20">4</span>
                                ...
                                <li>
                                        ...
                                        <span class=""><form method="POST" action="{{ route('logout') }}">
                                @csrf
